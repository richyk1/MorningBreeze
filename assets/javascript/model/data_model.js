...
class Beverage {
    ...
    constructor(productNameBold, productNameThin, imageUrl, taste, usage, country, price) {
        ...
        this.price = price;
        this.stock = Math.floor(Math.random() * 100); // Stock between 1 - 100
    }
}
...
class Data {
    constructor() {
         ...
         */
        this.currentUser = new User(ACCESS_LEVELS.REGULAR, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined);
